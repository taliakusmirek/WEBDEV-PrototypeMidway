  ...
  <article class="card" tabindex="0" data-id="${question.id}">
    ...
    <div class="card__body">
      ...
      <div class="card__footer">
        ...
        <button class="pill" data-card-upvote="${question.id}" aria-label="Upvote question">+${question.upvotes ?? 0}</button>
      </div>
    </div>
  </article>`;
}
